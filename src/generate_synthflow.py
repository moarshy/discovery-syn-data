"""Structured data generator for SynthFlow — voice AI agent platform.
...
INDUSTRIES = [
    "Healthcare", "Real Estate", "Insurance", "Financial Services",
    "E-commerce", "BPO/Call Centers", "Retail", "Technology",
]
...
FEATURES = [
    ...
    {"name": "call_routing", "activation_difficulty": "low"},
    {"name": "crm_integration", "activation_difficulty": "medium"},
    {"name": "analytics_dashboard", "activation_difficulty": "medium"},
    {"name": "custom_voices", "activation_difficulty": "high"},
    {"name": "api_access", "activation_difficulty": "high"},
    {"name": "sla_support", "activation_difficulty": "medium"},
    {"name": "multi_language", "activation_difficulty": "high"},
]
...
def generate_campaigns(accounts_df: pd.DataFrame) -> pd.DataFrame:
    """Generate agent deployment and outbound calling campaigns per account.
    ...
    for _, acct in accounts_df.iterrows():
        ...
        for _ in range(n_campaigns):
            campaign_type = random.choice(["agent_deployment", "outbound_campaign"])
...
def _generate_admin_session(account, event_id, session_ts):
    ...
    # 30% chance of agent creation in this session
...
def generate_all():
    """Generate complete SynthFlow dataset and write to synthflow.db."""
    company = "synthflow"
